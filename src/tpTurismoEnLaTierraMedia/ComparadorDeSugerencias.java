...
public class ComparadorDeSugerencias implements Comparator<Sugerible> {
	...
	public int compare(Sugerible s1, Sugerible s2) {
		...
		if (this.preferencia == s1.getTipoAtraccion() && this.preferencia != s2.getTipoAtraccion())
			return -1;
		else if (this.preferencia != s1.getTipoAtraccion() && this.preferencia == s2.getTipoAtraccion())
			return 1;
		// primero promocion
